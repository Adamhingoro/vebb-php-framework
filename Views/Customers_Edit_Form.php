...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-body">
          <form role="form" action="<?php echo url_to(array("Customers","Edit" , $id)); ?>" method="post">
              <div class="box-body">
              ...
              <div class="alert alert-warning alert-dismissible">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="fullname" name="fullname" value="<?php echo $row['name']; ?>" placeholder="Abdul Bari" type="text">
                </div>
                
                <div class="form-group">
                  <label for="email">Email address</label>
                  <input class="form-control" id="email" name="email" value="<?php echo $row['email']; ?>" placeholder="Enter email" type="email">
                </div>
                
                <div class="form-group">
                  <label for="company">Company name</label>
                  <input class="form-control" id="company" name="company" value="<?php echo $row['company']; ?>" placeholder="Enter company" type="text">
                </div>
                
                <div class="form-group">
                  <label for="desc">Customer Details</label>
                  <textarea class="form-control" id="desc" name="desc" rows="3" placeholder="Enter customer description"><?php echo $row['description']; ?></textarea>
                </div>
