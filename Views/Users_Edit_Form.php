...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-body">
          <form role="form" action="<?php echo url_to(array("Users","Edit",$model['user']['id'])); ?>" method="post">
              <div class="box-body">
              ...
              <div class="alert alert-warning alert-dismissible">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="fullname" name="fullname" placeholder="Abdul Bari" value="<?php echo $model['user']['name']; ?>" type="text">
                </div>
                
                <div class="form-group">
                  <label for="email">Email address</label>
                  <input class="form-control" id="email" name="email" placeholder="Enter email" value="<?php echo $model['user']['email']; ?>" type="email">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="role" id="role">
                    <option <?php echo ($model['user']['role'] == '0') ? 'selected' : ''; ?> value="0">Super Administrator</option>
                    <option <?php echo ($model['user']['role'] == '1') ? 'selected' : ''; ?> value="1">Sales Manager</option>
                    <option <?php echo ($model['user']['role'] == '2') ? 'selected' : ''; ?> value="2">Hr Manager</option>
                  </select>
                </div>
              </div>
              <!-- /.box-body -->
