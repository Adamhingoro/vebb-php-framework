...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-body">
          <form role="form" action="<?php echo url_to(array("Departments","Edit",$model['depart']['id'])); ?>" method="post">
              <div class="box-body">
              ...
              <div class="alert alert-warning alert-dismissible">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="fullname" name="fullname" placeholder="Abdul Bari" value="<?php echo $model['depart']['name']; ?>" type="text">
                </div>
              <!-- /.box-body -->
