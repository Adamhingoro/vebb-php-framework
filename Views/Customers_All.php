...
<head>
  ...
  <title><?php echo APP_TITLE; ?> | All Customers</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Customers
        <small>All Customers are Listed Here.</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="box">
        <div class="box-body">
          ...
          <table class="table table-striped">
                ...
                <?php
                if(isset($model['customers']))
                {
                  
                  foreach($model['customers'] as $row )
                  {
                ?>
                <tr>
                  ...
                  <td><a href="<?php echo url_to(array("Customers","Edit",$row['id'])); ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a><a href="<?php echo url_to(array("Customers","Delete",$row['id'])); ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a></td>
                </tr>
