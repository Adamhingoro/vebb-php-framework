...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Service Log
        <small>Add new Service log.</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-body">
          <form role="form" action="<?php echo url_to(array("Servicelog","Add" , $id)); ?>" method="post">
              ...
              <div class="alert alert-warning alert-dismissible">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="employe_id" id="employe_id">
                    ...
                    <?php foreach($model['employes'] as $row){ ?>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input class="form-control" type="number" name="hours_worked" id="hours_worked">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="note" name="note" rows="3" placeholder="Enter log note.."></textarea>
                </div>
              </div>
              <!-- /.box-body -->

              <div class="box-footer">
                <button type="submit" class="btn btn-primary pull-right">Log service status</button>
              </div>
            </form>
        </div>
      </div>
