...
<div class="wrapper">
  ...
  ?>
      ...
      <div class="box">
        <div class="box-body">
          <form role="form" action="<?php echo url_to(array("Services","Edit" , $id)); ?>" method="post">
              <div class="box-body">
              ...
              <div class="alert alert-warning alert-dismissible">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="fullname" name="fullname" value="<?php echo $row['name']; ?>" placeholder="Service name" type="text">
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="desc" name="desc" rows="3" placeholder="Enter service description..."><?php echo $row['description']; ?></textarea>
                </div>
              </div>
              <!-- /.box-body -->
