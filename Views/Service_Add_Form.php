...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-body">
          <form role="form" action="<?php echo url_to(array("Services","Add")); ?>" method="post">
              <div class="box-body">
              ...
              <div class="alert alert-warning alert-dismissible">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="fullname" name="fullname" placeholder="Service name" type="text">
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="desc" name="desc" rows="3" placeholder="Enter service description..."></textarea>
                </div>
              </div>
              <!-- /.box-body -->

              <div class="box-footer">
                <button type="submit" class="btn btn-primary pull-right">Add new service</button>
              </div>
            </form>
        </div>
      </div>
