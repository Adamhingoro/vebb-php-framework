...
<head>
  ...
  <title><?php echo APP_TITLE; ?> | All Services</title>
      ...
      <div class="box">
        <div class="box-body">
          ...
          <table class="table table-striped">
                ...
                ?>
                <tr>
                  <td><img style="height:100px;"  class="profile-user-img img-responsive img-circle" src="/Uploads/<?php echo $employe_model->get_image($row['employe_id']); ?>" alt="User profile picture"></td>
                  <td>
                    <blockquote>
                      <p><?php echo $row['note']; ?></p>
                      <small><?php echo $employe_model->get_name($row['employe_id']); ?> <cite title="Source Title"><?php echo $employe_model->get_department($row['employe_id']); ?> </cite></small>
                    </blockquote>
                  </td>
                  <td><b><?php echo $row['hours_worked']; ?>:00</b></td>
                  <td><a href="<?php echo url_to(array("Servicelog","Edit",$row['id'])); ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a><a href="<?php echo url_to(array("Servicelog","Delete",$row['id'])); ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a></td>
                </tr>
                
                <?php } } else { ?>
                <tr><td colspan=4><center><h4>No log found against this order in the system...!</h4></center></td></tr>
                <?php } ?>
              </tbody></table>
        </div>
      </div>
