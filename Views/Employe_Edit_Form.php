...
<div class="wrapper">
  ...
  ?>
      ...
      <div class="box">
        <div class="box-body">
          <form role="form" action="<?php echo url_to(array("Employes","Edit" , $id)); ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="alert alert-warning alert-dismissible">
                ...
                <div class="row">
                  <div class="col-xs-3">
                    <img style="height:300px; width:300px;"  class="profile-user-img img-responsive" src="/Uploads/<?php echo $employe['image']; ?>" alt="Employe profile picture">
                  </div>
                  <div class="col-xs-9">
                    
                <div class="form-group">
                  <label for="fullname">Full Name</label>
                  <input class="form-control" id="fullname" name="fullname" value="<?php echo $employe['name']; ?>" placeholder="Abdul Bari" type="text">
                </div>
                
                <div class="form-group">
                  <label for="email">Email address</label>
                  <input class="form-control" id="email" name="email" value="<?php echo $employe['email']; ?>" placeholder="Enter email" type="email">
                </div>
                
                <div class="form-group">
                  <label for="address">Address</label>
                  <input class="form-control" id="address" name="address" value="<?php echo $employe['address']; ?>" placeholder="Enter address" type="text">
                </div>
                
                <div class="form-group">
                  <label for="summary">Summary</label>
                  <textarea class="form-control" id="summary" name="summary" rows="3" placeholder="Enter professional summary..."><?php echo $employe['summary']; ?></textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="department" id="department">
                    ...
                    <option <?php echo ($employe['department'] == $row['id']) ? 'Selected' :  ''; ?>    value="<?php echo $row['id'];?>"><?php echo $row['name'];?></option>
                    <?php } ?>
                  </select>
                </div>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary pull-right">Update employe</button>
              </div>
            </form>
        </div>
      </div>
