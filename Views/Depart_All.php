...
<head>
  ...
  <title><?php echo APP_TITLE; ?> | All Departments</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Departments
        <small>Current Departments</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="box">
        <div class="box-body">
          ...
          <table class="table table-striped">
                ...
                <?php
                if(isset($model['departs']) && count($model['departs']) > 0)
                {
                  foreach($model['departs'] as $user )
                  {
                ?>
                <tr>
                  <td><?php echo $user['id']; ?></td>
                  <td><?php echo $user['name']; ?></td>
                  <td><a href="<?php echo url_to(array("Departments","Edit",$user['id'])); ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a><a href="<?php echo url_to(array("Departments","Delete",$user['id'])); ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a></td>
                </tr>
                
                <?php } } else { ?>
                <tr><td colspan=3><center><h3>No Departments in the system...!</h3></center></td></tr>
                <?php } ?>
              </tbody></table>
        </div>
      </div>
