...
<head>
  ...
  <title><?php echo APP_TITLE; ?> | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo PUBLIC_ASSETS; ?>/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Excel</b>ON</a>
  </div>
  <!-- /.login-logo -->
  ...
  <div class="alert alert-warning alert-dismissible">
    ...
    <?php } ?>
    <form action="<?php echo url_to(array("Home","Login")); ?>" method="post">
...
<!-- iCheck -->
<script src="<?php echo PUBLIC_ASSETS; ?>/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
