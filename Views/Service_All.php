...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Services
        <small>All Services are Listed Here.</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="box-body">
          ...
          <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo url_to(array("Services","Edit",$row['id'])); ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a><a href="<?php echo url_to(array("Services","Delete",$row['id'])); ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a></td>
                </tr>
                
                <?php } } else { ?>
                <tr><td colspan=4><center><h4>No Services in the system...!</h4></center></td></tr>
                <?php } ?>
              </tbody></table>
        </div>
      </div>
