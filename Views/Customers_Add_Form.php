...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-body">
          <form role="form" action="<?php echo url_to(array("Customers","Add")); ?>" method="post">
              <div class="box-body">
              ...
              <div class="alert alert-warning alert-dismissible">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="company" name="company" placeholder="Enter company" type="text">
                </div>
                
                <div class="form-group">
                  <label for="desc">Customer Details</label>
                  <textarea class="form-control" id="desc" name="desc" rows="3" placeholder="Enter customer description"></textarea>
                </div>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary pull-right">Add new customer</button>
              </div>
            </form>
        </div>
      </div>
